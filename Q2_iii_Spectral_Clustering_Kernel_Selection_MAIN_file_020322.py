...
"""MAIN FILE
Q2_iii_Spectral_Clustering_Kernel_Selection_import_file_020322.py file is imported into this MAIN FILE

Run this main file and Q2_iii_Spectral_Clustering_Kernel_Selection_import_file_020322 module will be 
automatically invoked 

"""


print("Plotting coloured clusters (k=4) for fixed rand. init. for kernels and choosing best kernel for dataset")
...
from Q2_iii_Spectral_Clustering_Kernel_Selection_import_file_020322 import Compute_H_star_matrix #, H_star_unit_row_vector_normalied
...
for select_a_kernel in range(0,3):
    ...
    for rand_init in range (0, 1):
        ...
        k_means_centroid_cordinates_new, k_means_class, sample_class_dict, sample_class_dict_2, sample_class_dict_3, sample_class_dict_4 = Get_K_Means_Centroid_Cordinates(k_means, H_star_unit_row_vector_normalied)
...
K means coordinates found, breaking from while loop
Cost for k = 4 : 0.16575618336281064 
